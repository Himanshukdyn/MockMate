    ...
    <div className='flex justify-center items-center min-h-[90vh] bg-gray-50 dark:bg-slate-950 sm:px-6 py-10'>
      <div className='w-full max-w-md bg-white dark:bg-slate-900 p-6 sm:p-10 border border-gray-200 dark:border-slate-800 rounded-2xl shadow-xl dark:shadow-none'>
        <div className='text-center mb-8'>
          ...
          <h1 className='text-3xl sm:text-4xl font-black text-gray-900 dark:text-white leading-tight'>Welcome <span className='text-teal-500'>Back</span></h1>
        ...
        <p className="mt-8 text-center text-sm text-gray-500 dark:text-slate-400">
          New here? <Link to="/register" className="text-teal-600 dark:text-teal-400 font-bold hover:underline">Create an account</Link>
        </p>
      </div>
    </div>
  )
